...
public class MainAnnotationsActivity extends Activity {
	...
	@ItemClick
	protected void sitesListItemClicked(Gempa selectedSite) {
	...
	protected void loadList(){
		mAdapter = new GempaAdapter(this, -1, SitesXmlPullParser.getStackSitesFromFile(this));
